...
-- Comments
-- For Product ID 2 (Italian Tomato)
...
-- For Product ID 13 (Vanilla Puff Cereal)
INSERT INTO COMMENT (ID, TEXT, PRODUCT_ID) VALUES
...
-- For Product ID 16 (Canned Minestrone Soup)
INSERT INTO COMMENT (ID, TEXT, PRODUCT_ID) VALUES
    (17, 'Great value!', 16);

-- For Product ID 24 (Organic Lemonade Juice)
INSERT INTO COMMENT (ID, TEXT, PRODUCT_ID) VALUES
    (18, 'My favourite :)', 24);

-- For Product ID 30 (Berry Chewy Granola Bars)
INSERT INTO COMMENT (ID, TEXT, PRODUCT_ID) VALUES
